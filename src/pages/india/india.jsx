...
import './india.css'; // Ensure this path is correct
...
const Plan = ({ imageSrc, name, details, fees }) => (
  <div className="plan">
    ...
    <a href="https://docs.google.com/forms/d/e/1FAIpQLSee7NyUs16TrVU9rml3AyhuDUB9CGDmNO1F870OC79BFaatog/viewform" className="choose-plan-btn" target="_blank" rel="noopener noreferrer">
      Register
    </a>
  </div>
);
