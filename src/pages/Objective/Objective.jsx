  ...
  return (
    <div className="objective_container">
      ...
      <div className="objective_right" ref={objectiveRightRef}>
        <h1 style={{ fontSize: "4rem",textAlign:'center' }}>Objective</h1>
        <p style={{ marginTop: "1.5rem", fontSize: "1.3rem" }}>
          The Objective and Scope of BKS is covered all concepts with its
          application.The scientific rigor and heritage that was existing in our
          country with following subjects will be true eye opener for young
          students. The principal objective of Bhartiya Knowledge System is to
